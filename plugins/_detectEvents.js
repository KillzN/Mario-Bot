...
export async function before(m, {conn, participants}) {
  ...
  const pp = await conn.profilePictureUrl(m.chat, 'image').catch((_) => null) || 'https://raw.githubusercontent.com/BrunoSobrino/Mᴀʀɪᴏ ʙʀᴏss/master/src/avatar_contact.png';
